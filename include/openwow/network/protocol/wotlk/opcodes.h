...
enum class Opcode : std::uint16_t {
  ...
  SMSG_BATTLEFIELD_MGR_STATE_CHANGE                    = 0x4DE,
  CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE           = 0x4DF,
  SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                    = 0x4E0,
  SMSG_BATTLEFIELD_MGR_ENTRY_INVITE                    = 0x4E1,
  CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE           = 0x4E2,
  CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST                   = 0x4E3,
  SMSG_BATTLEFIELD_MGR_ENTERED                         = 0x4E4,
  SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE          = 0x4E5,
  SMSG_BATTLEFIELD_MGR_EJECT_PENDING                   = 0x4E6,
  CMSG_BATTLEFIELD_MGR_EXIT_REQUEST                    = 0x4E7,
  SMSG_BATTLEFIELD_MGR_EJECTED                         = 0x4E8,
  ...
  SMSG_ITEM_CHARGES_UPDATE                            = 0x50B,
...
inline constexpr std::uint16_t kNumOpcodes = static_cast<std::uint16_t>(Opcode::NUM_MSG_TYPES);

[[nodiscard]] inline constexpr std::uint16_t OpcodeValue(Opcode op) {
  return static_cast<std::uint16_t>(op);
}

[[nodiscard]] const char* OpcodeName(Opcode op);
[[nodiscard]] const char* OpcodeName(std::uint16_t op);

constexpr std::uint8_t AUTH_OK                      = 12;
constexpr std::uint8_t AUTH_FAILED                  = 13;
constexpr std::uint8_t AUTH_REJECT                  = 14;
constexpr std::uint8_t AUTH_BAD_SERVER_PROOF         = 15;
constexpr std::uint8_t AUTH_UNAVAILABLE             = 16;
constexpr std::uint8_t AUTH_SYSTEM_ERROR            = 17;
constexpr std::uint8_t AUTH_BILLING_ERROR           = 18;
constexpr std::uint8_t AUTH_BILLING_EXPIRED         = 19;
constexpr std::uint8_t AUTH_VERSION_MISMATCH        = 20;
constexpr std::uint8_t AUTH_UNKNOWN_ACCOUNT         = 21;
constexpr std::uint8_t AUTH_INCORRECT_PASSWORD      = 22;
constexpr std::uint8_t AUTH_SESSION_EXPIRED         = 23;
constexpr std::uint8_t AUTH_DATABASE_BUSY           = 26;
