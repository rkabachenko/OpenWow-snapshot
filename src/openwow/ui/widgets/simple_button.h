...
class CSimpleButton : public CSimpleFrame {
 public:
  ...
  void LockButtonState() noexcept { buttonStateLocked_ = true; }
  void UnlockButtonState() noexcept { buttonStateLocked_ = false; }
  [[nodiscard]] bool IsButtonStateLocked() const noexcept { return buttonStateLocked_; }
