...
class WorldTransitionController final {
 public:
  ...
  void ArmWorldportAck() noexcept { worldport_ack_pending_ = true; }
  void ClearWorldportAck() noexcept { worldport_ack_pending_ = false; }
  [[nodiscard]] bool HasPendingWorldportAck() const noexcept {
    return worldport_ack_pending_;
  }
 ...
 private:
  ...
  bool worldport_ack_pending_{false};
