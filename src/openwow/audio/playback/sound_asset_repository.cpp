...
void SoundRuntime::SetIndoorSoundArea(const std::int32_t area_id) {
  ...
  const std::int32_t ambience_sound_kit_id =
      area_id != 0 ? kUnderwaterAmbienceSoundKitId : -1;
  zone_ambience_selection_entries_[kUnderwaterAudioSelectionPriority]
      .sound_kit_ids = {ambience_sound_kit_id, ambience_sound_kit_id};
