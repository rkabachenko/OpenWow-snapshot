...
constexpr float kM2MaterialFogGrayChannel = 128.0f / 255.0f;
...
RenderVec4 ResolveM2MaterialFogColor(const M2MaterialFogMode mode,
  ...
  case M2MaterialFogMode::Gray:
    ...
    return RenderVec4{kM2MaterialFogGrayChannel, kM2MaterialFogGrayChannel,
                      kM2MaterialFogGrayChannel, scene_fog_color[3]};
